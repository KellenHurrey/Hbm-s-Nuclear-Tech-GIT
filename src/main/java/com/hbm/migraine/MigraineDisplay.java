...
public class MigraineDisplay {
	...
	public MigraineDisplay setLineDist(int dist) {
		this.lineDist = dist;
		return this;
	}

	public MigraineDisplay setOrientation(MigraineDisplay.Orientation o) {
		this.o = o;
		return this;
	}

	public MigraineDisplay setColors(int brighter, int frame, int darker, int background) {
	...
	public MigraineDisplay setColors(int[] colors) {
	...
	public void drawForegroundComponent(int w, int h) {
	...
	protected void drawRect(int minX, int minY, int maxX, int maxY, long color) {
		drawGradientRect(minX, minY, maxX, maxY, color, color);
	}

	protected void drawGradientRect(int minX, int minY, int maxX, int maxY, long color1, long color2) {
	...
	public void drawTexturedModalRect(int posX, int posY, int u, int v, int sizeX, int sizeY, long color) {
		double zLevel = 300D;
