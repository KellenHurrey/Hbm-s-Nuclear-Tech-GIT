		...
		if(!worldObj.isRemote && worldObj.isBlockIndirectlyGettingPowered(xCoord, yCoord, zCoord)) {
			...
			if(b == ModBlocks.vent_chlorine) {
				//if(worldObj.rand.nextInt(1) == 0) {
					double x = worldObj.rand.nextGaussian() * 1.5;
					double y = worldObj.rand.nextGaussian() * 1.5;
					double z = worldObj.rand.nextGaussian() * 1.5;
			...
			if(b == ModBlocks.vent_cloud) {
				...
				double x = worldObj.rand.nextGaussian() * 1.75;
				double y = worldObj.rand.nextGaussian() * 1.75;
				double z = worldObj.rand.nextGaussian() * 1.75;
			...
			if(b == ModBlocks.vent_pink_cloud) {
				//if(worldObj.rand.nextInt(65) == 0) {
				double x = worldObj.rand.nextGaussian() * 2;
				double y = worldObj.rand.nextGaussian() * 2;
